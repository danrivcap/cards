...
/**
 * Public contract of a card Deck, it could be multiple implementations of a Deck in shape (Pocker, Spanish) and
...
public interface Deck<S extends Suit ,F extends Face> {
	 ...
	 *Optional allow client control of not card deal in a cleaner way than an Exception or a null
	 **/
